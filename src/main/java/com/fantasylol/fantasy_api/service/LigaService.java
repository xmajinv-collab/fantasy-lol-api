...
public class LigaService {
    ...
    public Liga crearLiga(String nombre, String username) {
        ...
        liga.setCodigoInvitacion(generarCodigo());
    ...
    public void unirseLiga(String codigo, String username) {
        ...
        boolean yaExiste = equipoRepository.existsByLigaAndUsuario(liga, usuario);
    ...
    public List<RankingDTO> obtenerRanking(Long ligaId) {
        ...
        for (Equipo equipo : equipos) {
            ...
            int puntosEquipo = equipo.getJugadores()
                    .stream()
    ...
    public LigaDashboardDTO obtenerDashboard(Long ligaId, String username) {
        ...
        List<Jugador> mercado = jugadorRepository
                .findByLigaIdAndEnMercadoTrue(ligaId);
